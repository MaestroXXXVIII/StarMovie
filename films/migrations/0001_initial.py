    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_premiere', models.DateField(default=datetime.date.today, verbose_name='Примера в мире')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='films.actor', verbose_name='режиссер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.fields.CharField, to='films.movie', verbose_name='фильм')),
